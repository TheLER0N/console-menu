...
ApplyFullscreen();
RegisterHotkey();
if (ShellDataService.Settings != null && ShellDataService.Settings.RestMode) EnterRestMode();
}
public void EnterRestMode()
{
if (ShellDataService.Settings != null) { ShellDataService.Settings.RestMode = true; ShellDataService.SaveSettings(); }
Hide();
}
public void ExitRestMode()
{
if (ShellDataService.Settings != null) { ShellDataService.Settings.RestMode = false; ShellDataService.SaveSettings(); }
Show();
Activate();
ApplyFullscreen();
}
...
_hotkey = new HotkeyService(this, () => { if (IsVisible) ShowOverlay(); else ExitRestMode(); });
